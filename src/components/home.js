    ...
    <section className="home-page">
      <div className="home-page-box">
        <div className="welcome-box">
          <h2 className="banner">
            Build An Adventure <br /> Embark upon a journey of learning!{' '}
          </h2>
          <h3 className="blurb">
            The knowledge Maze is a tool to build highly customizable, branched, text and video
            based adventures. Build out the choices and they consequences, and invite others to
            travel down paths you create!
          </h3>
        </div>
