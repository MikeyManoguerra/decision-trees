...
import './Tutorial.css'
import { studentEndTutorial, studentNextTutorial } from '../actions'
  ...
  render() {
    ...
    return (
      <div className="tutorialBox">
        <img
          src={imgSrc1}
          alt="Student Landing Page containing a LearnVenture ID input and password"
        ></img>
        <p>
          If a teacher gave you a LearnVenture ID, please put it in the first white input box (with
          the numbers and letters)
        </p>
        <p>
          If a teacher gave you a password, you may put it in the second white input box below the
          first one
        </p>
